...
s.trackingServer="o.mylifetime.com" 
s.trackingServerSecure="o.mylifetime.com"
...
/* External Campaign Tracking */
  if(!s.campaign) {        
	s.campaign=s.getQueryParam('cmpid');//Set campaign here if not set in page already.
	s.campaign=s.getValOnce(s.campaign,'s_campaign',0);
        s.eVar26=s.campaign;
}          
/* Internal Campaign Tracking */
  if(!s.eVar25) {
	s.eVar25=s.getQueryParam('intcmp');//Set internal campaign here if not set in page already.
...
s.prop11=s.eVar11=s.getTimeParting('h','-8',year); // Set hour 
s.prop12=s.eVar12=s.getTimeParting('d','-8',year); // Set day
s.prop13=s.eVar13=s.getTimeParting('w','-8',year); // Set Weekend / Weekday
...
s.visitorNamespace="lifetimeentertainment"
s.dc=112
